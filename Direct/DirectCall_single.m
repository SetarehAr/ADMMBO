function [ xmin,fmin ] = DirectCall_single( prob )
%------------------------------------------------------%
% DIRECT Sample Call                                   %
...
Problem.constraint(i).func    = prob.c;
Problem.constraint(i).parameters= prob.c_parameters;
...
%{
 MAKE THIS EFFECTIVE WHEN MODIFIED FOR MULTIPLE CONSTRAINTS
for i=1:Problem.numconstraints
...
[fmin,xmin,hist] = Direct_with_INPUT_Parameters_single(Problem,bounds);
